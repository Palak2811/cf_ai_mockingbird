/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2ed47bc5d6cff344dbd85edfea9caf4)
// Runtime types generated with workerd@1.20260918.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	PrepAgent: DurableObjectNamespace<import("./src/server/index").PrepAgent>;
	PREP_WORKFLOW: Workflow<Parameters<import("./src/server/index").PrepWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "PrepAgent";
	}
